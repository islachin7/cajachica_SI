        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="form-group">
                  ...
                  <input type="hidden" id="comprobante" name="comprobante" value="<?php  if(isset($movi)){ echo $movi["comprobante"]; } ?>" />
                  <input autocomplete="off" class="form-control input-md" type="text" id="cmpb" value="<?php  if(isset($movi)){ echo $movi["factura"]; } ?>"  placeholder="Buscar por N° de comprobante" style="border-radius: 5px">
                  <style type="text/css">
                    .boton-prueba{
    ...
    height: 150%;">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input id="monto" class="form-control" type="number"  name="monto" value="<?php  if(isset($movi)){ echo $movi["monto"]; } ?>" required readonly>
              </div>
            </div>
