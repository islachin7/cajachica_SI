...
<style>
  .custom-control-label::before{background-color: #355c83;}
</style>
      ...
      <div class="container padding-bottom-3x mb-2 py-5">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <h3 class="margin-bottom-1x">Actualización de Usuario:</p>
            <form class="row" method="post" action="<?= base_url() ?>/usuario/actualizarUsuarioAdm">
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="reg-pass">Nombre:</label>
                  <input class="form-control" type="text" id="transfe"  name="id" value="<?=$usuario['id']?>" hidden>
                  <input autocomplete="off" class="form-control" type="text" id="transfe"  name="nombre" value="<?=$usuario['nombre']?>">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="reg-pass">Apellido:</label>
                  <input autocomplete="off" class="form-control" type="text" id="transfe"  name="apellido" value="<?=$usuario['apellido']?>" >
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="reg-pass">Celular:</label>
                  <input autocomplete="off" class="form-control" type="text" id="transfe"  name="celular" value="<?=$usuario['celular']?>" >
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="reg-pass">Tipo de Usuario:</label>
                  <select id="tipoo" class="form-control" name="tipousuario">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input autocomplete="off" class="form-control" type="text" id="transfe"  name="correo" value="<?=$usuario['correo']?>" >
                </div>
              </div>
              <div class="col-sm-4">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input autocomplete="off" class="form-control" type="password" id="contra1"  name="password" hidden="" >
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="reg-pass" id="labelcontra2" hidden="">Confirmar Contraseña:</label>
                  <input autocomplete="off" class="form-control" type="password" id="contra2"  name="confirmar_password" hidden="" >
                </div>
              </div>
