...
?>
      <section class="container padding-top-3x padding-bottom-3x">
       ...
       <?php if(isset($prub)){ ?>
        <form class="row py-2" method="post" action="<?= base_url() ?>/proyectoc/filtrar">

            <div class="col-sm-3"></div>
            <div class="col-sm-5">
              <div class="form-group">
                <label for="reg-phone">Usuario:</label>
                <select class="form-control" name="filusuario" required>
                  <option value="noselecciono" selected>Buscar por usuario:</option>
