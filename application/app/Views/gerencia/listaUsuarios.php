...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.24/css/dataTables.bootstrap4.min.css"/>
    ...
    ¿Esta seguro de desactivar al usuario?
        ...
        <h2>Lista de Usuarios</h2>
              ...
              <table id="peass" class="table table-responsive table-hover" style="border-radius:20px" >
                ...
                <tbody>
                  ...
                  <?php  if($row->tipousuario=="desactivado"){ ?>
                    ...
                    <tr class="text-danger">
                      ...
                      <td class="align-middle text-center"><a href="<?=base_url()?>/usuario/actuUsuario?id=<?=$row->id?>" class="btn btn-outline-primary">

                        <i class="fas fa-edit"></i>

                      </a></td>

                      <td class="align-middle text-left"><a disabled class="btn btn-outline-danger" data-toggle="modal" data-target="#modaleliminar" id="elimnando<?php echo $row->id; ?>">
                  ...
                  <?php  }else{ ?>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-left"><a class="btn btn-outline-danger" data-toggle="modal" data-target="#modaleliminar" id="elimnando<?php echo $row->id; ?>">
