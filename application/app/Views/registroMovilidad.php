        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="form-group">
                  ...
                  <input autocomplete="off" class="form-control input-md" type="text" id="cmpb"  placeholder="Buscar por N° de comprobante" style="border-radius: 5px">
                  <style type="text/css">
                    .boton-prueba{
    ...
    height: 150%;">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                ...
                <input id="monto" class="form-control" type="number" name="monto" required readonly>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  if(palabra.length >= 1){
    $.ajax({
      url:base_url + '/cajaChicac/buscarComprobante',
      method: "POST",
      dataType: "json",
      data:{
        palabra :palabra,
