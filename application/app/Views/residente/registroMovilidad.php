      ...
      <div class="container padding-bottom-3x mb-2 py-5">
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <h3 class="margin-bottom-1x">Registro de Movilidad</h3>
            <p>Llene todos los campos con la información requerida.</p>
            <form class="row" method="post" action="<?= base_url() ?>/cajaChicac/registrarMovilidad">
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input id="fecha" class="form-control" type="date"  name="fecha" value="<?php  if(isset($fecha)){ echo $fecha; } ?>" required>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input id="origen" autocomplete="off" class="form-control" type="text"  name="origen" required>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input id="destino" autocomplete="off" class="form-control" type="text"  name="destino" required>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input id="monto" onblur="F_calculoTotal();" class="form-control" type="number" step="0.01" value="0.00" name="monto" required>
              </div>
            </div>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <input class="form-control" type="text" id="saldoFinal" value="<?php if(isset($caja) && isset($consumido)){ echo (($caja["montoTotal"]+$aumento) - $consumido); } ?>"  readonly>
              </div>
            </div>
            ...
            <div class="col-sm-5">
              <div class="form-group">
                ...
                <textarea id="motivo" class="form-control" name="motivo" required></textarea>
              </div>
            </div>

            <input id="cerrado" type="hidden" name="cerrar" value="" />

              <div class="col-sm-7 text-center text-sm-right pt-4">
                <a id="botonregistrar" onclick="F_registrar2();" class="btn btn-primary margin-bottom-none" >Registrar</a>
                <a id="botonregistrar" onclick="F_registrar();" class="btn btn-primary margin-bottom-none" >Registrar y Salir</a>
...
<script type="text/javascript">
  ...
  <?php if(isset($mensaje2)):?>
    <script>
        toastr.success('<?=$mensaje2?>','Notificación',{"closeButton": true,"debug": false,"newestOnTop": false,"progressBar": true,"positionClass": "toast-top-right","preventDuplicates": false,"onclick": null,"showDuration": "5000","hideDuration": "5000","timeOut": "5000","extendedTimeOut": "5000","showEasing": "swing","hideEasing": "linear","showMethod": "fadeIn","hideMethod": "fadeOut"});
    </script>
  <?php endif; ?>
