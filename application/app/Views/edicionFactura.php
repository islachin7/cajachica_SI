      ...
      <div class="container padding-bottom-3x mb-2 py-5">
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <h3 class="margin-bottom-1x">Edición de Comprobante</h3>
            <p>Llene todos los campos con la información requerida.<br>
            <strong style="color:red;">La movilidad o el refrigerio asociado, se vera afectado también.</strong></p> 
            <form style="display: flex;justify-content: space-around;" class="row" method="post" action="<?= base_url() ?>/cajaChicac/editarFactura">
...
<script type="text/javascript">
    $(document).ready(function() {
        <?php if(isset($factura)){ ?>
            ...
            $("#tipoCmpb").val(<?=$factura["tipoCmpb"]?>);

            let siigv = <?php if($factura["igv"]!=""){ echo $factura["igv"];}else{ echo 1;} ?>;
